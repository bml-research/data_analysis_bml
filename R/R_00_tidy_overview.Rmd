...
<details>
<summary><strong>glimpse()</strong>The function `ggplot()` is used to create visualizations of your data.</summary>
...
Adds a statistical summary (e.g., a smooth line fit to the data).
...
For a complete overview of GGPLOT see [this](https://ggplot2.tidyverse.org/index.html) link.

You can also download a pdf cheatsheet [here](https://github.com/rstudio/cheatsheets/blob/main/data-visualization.pdf).
...
<details>
<summary><strong>glimpse()</strong>The function `glimpse()` is great for quick inspection of your data. Helps you verify column types and spot missing or unexpected values.</summary>
...
<details>
<summary><strong>pull()</strong>The function `pull()` is used to extract a single column from a data frame or tibble as a vector.</summary>
...
<details>
<summary><strong>count()</strong>The function `count()` is used to tally the number of occurrences of values in one or more columns.</summary>
