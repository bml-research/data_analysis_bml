...
<details>
<summary><strong>pull()</strong>The function `pull()` is a used to extract a single column from a data frame or tibble as a vector.</summary>
...
<details>
<summary><strong>count()</strong>The function `count()` is a used s used to tally the number of occurrences of values in one or more columns.</summary>
