...
```
Now can calculate the percentage and add to new column:
...
The motor proteins are the smallest fraction of expression value - stimulus.
...
The `Signal transducing proteins` have the lowest median for expression value - stimulus.
...
Thus, puromycin acts as an activator.
