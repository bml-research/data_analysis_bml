...
We can explore the levels as follows:
...
Adding labels with % in the Pie is a bit of a hassle.
It is easier to show them in the legend:
First we calculate the percentage for each category:
