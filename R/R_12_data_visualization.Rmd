...
But first we can just take the culumns that we need:
...
See this [web page](https://blog.digitalogy.co/list-of-top-r-libraries-for-data-visualization/) for an overview.
