...
df <- df %>% 
  ...
  mutate_at(c('average_length', 'average_weight', 'life_span'), as.numeric) #Creates numbers from strings
formatted_table(head(df))
```

### Exercise 3

[This](./files_07_data_cleaning_exercises/exercise03/Heart_Disease_Prediction_mod.csv) data set contains rows with duplicate data. Load the data and remove the duplicates from the data table.
...
Yes, there seems to be duplicates of the rows with index numbers 8 and 10.
