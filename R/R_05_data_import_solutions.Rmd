...
First, check the following files in your text editor. 
...
source <- c("Published", "Unpublished", "Unpublished", "Submitted", "Unpublished")
my_tibble <- tibble(protein_name, location, weight, date_submission, source)
