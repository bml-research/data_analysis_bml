...
```
\
This file can be downloaded [here](./R_04_data_import_add_solutions.Rmd).
\
...
Download the files [honey.csv](./files_04_data_import_exercises/add_exercises/honey.csv), [amylase.tsv](./files_04_data_import_exercises/add_exercises/amylase.tsv) and [prot_pred.csv](./files_04_data_import_exercises/add_exercises/prot_pred.csv) and move them to the same folder as this RMarkdown file.
...
df4 <- read_tsv("./amylase.tsv", locale = locale(decimal_mark = ","))
